    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8">
        <div className="flex items-center space-x-3 mb-2">
          <Building2 className="w-6 h-6 sm:w-8 sm:h-8 text-[#004040]" />
          <h1 className="text-2xl sm:text-3xl font-bold text-[#000]">Planos</h1>
        </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-start space-x-3 sm:space-x-4 flex-1">
                  <div className="bg-[#004040]/10 p-2 sm:p-3 rounded-lg flex-shrink-0">
                    <Building2 className="w-5 h-5 sm:w-6 sm:h-6 text-[#004040]" />
                  </div>
